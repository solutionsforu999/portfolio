import illustrator from '../images&gifs/illustrator.jpg';
        ...
        <>
            <div className="container aboutme">
                <div className='aboutmedesc' style={{ maxWidth: '90%', padding: '5px' }}>
                    <h3>About Me</h3>
                    <p>
                    Hi! I’m a dedicated Web & Mobile App Developer with professional experience,<br/> 
                    I enjoy building efficient, scalable web applications <br/>
                    I’m currently expanding my skillset into mobile app development with React Native.
                    </p>
